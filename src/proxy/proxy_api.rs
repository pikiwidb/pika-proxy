...
#[put("/shutdown/{xauth}")]
async fn shutdown(data: web::Data<ApiServer>, info: web::Path<Info>) -> impl Responder {
...
#[put("/sentinels/{xauth}")]
async fn rewatch_sentinels(data: web::Data<ApiServer>, info: web::Path<Info>) -> impl Responder {
